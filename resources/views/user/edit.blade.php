		...
		<div class="row" style="padding-top: 10px;">
			...
			<div class="col-sm-9">
				<div class="card" style="margin-bottom: 10px">
				  	<div class="card-body">
				  		@if($user == null)
				  			{{ Form::open(array('route' => array('user.update', $user2->id), 'method' => 'PUT')) }}
					  			<h2><small>Profil User</small></h2>
					  			<hr>
					  			<div class="form-group">
					  				{{ Form::label('first_name', 'First name', array('class' => 'form-label')) }}
					  				{{ Form::text('first_name', $user2->first_name, array('class' => 'form-control', 'placeholder' => 'First name')) }}
					  			</div>
					  			<div class="form-group">
					  				{{ Form::label('last_name', 'last name', array('class' => 'form-label')) }}
					  				{{ Form::text('last_name', $user2->last_name, array('class' => 'form-control', 'placeholder' => 'Last name')) }}
					  			</div>
					  			<div class="form-group">
					  				{{ Form::label('email', 'Email', array('class' => 'form-label')) }}
					  				{{ Form::text('email', $user2->email, array('class' => 'form-control', 'placeholder' => 'Email')) }}
					  			</div>
				  		...
				  		@else
				  			...
				  			@if(count($user->user_id) < 1 || $user == null)
					  			{{ Form::open(array('route' => 'bio.store', 'files' => 'true')) }}
						  			<hr style="margin-top:80px">
						  			<h2><small>Biodata</small></h2>
						  			<hr>
						  		...
						  		{{ Form::close() }}
				  			@else
					  			{{ Form::open(array('route' => array('bio.update', $user2->id), 'method' => 'POST', 'files' => 'true')) }}
						  			<hr style="margin-top:80px">
						  			<h2><small>Biodata</small></h2>
						  			<hr>
						  			<div class="form-group">
